...
def pull_mssql_woojin(**kwargs):
    ...
    for factory in factorys:
        ...
        db_test = client['raw_data']
        collection_test1 = db_test[f'{factory}_mold_data']
        collection_test1.create_index([("TimeStamp",ASCENDING),("Additional_Info_1",TEXT),("Filling_Time",ASCENDING),("Injection_Time",ASCENDING),("Barrel_Temperature_1",ASCENDING)],unique=True)
        try:
            result = collection_test1.insert_many(data,ordered=False)
        except Exception as e:
